...
Bootstrap snapshot. This file is refreshed by `scripts/build_system_index.py`.
...
- `knowledge-library/workflow-lessons/github-issue-reviewer-patch-authority-executor-agent-loop.md`
